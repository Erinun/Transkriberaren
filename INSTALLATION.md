...
2. **Windows SmartScreen-varning** kan visas eftersom appen inte är signerad med ett certifikat. Klicka **"Mer info"** och sedan **"Kör ändå"**.
3. Följ installationsguiden. Appen installeras per användare — ingen administratörsbehörighet krävs.
